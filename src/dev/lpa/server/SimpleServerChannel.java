            ...
            while (true) {
                ...
                for (int i = 0; i < clientChannels.size(); i++) {
                    ...
                    if (readBytes > 0) {
                        ...
                        channel.close();
                        clientChannels.remove(i);   // FIXME: use Iterator, don't remove while iterating
                    }   // FIXME: catch exception for single client connection/close/remove
                }
            }
        } catch (IOException e) {
            System.out.println("Server exception " + e.getMessage());
            // FIXME: loop and close channels
        }
    }
}
